...
public abstract class Character {
    ...
    protected void pick(Item newItem) throws Exception {///CHECK
    ...
    protected void useAt(int index, Character target){///CHECK INDEXES
    ...
    protected void printInventar(){
        for (int i = 0; i < Inventar.size(); i++){
            System.out.println(Inventar.get(i).getName());
        }
    }
    protected void printHotbar(){
